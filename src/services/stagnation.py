...
from kernel.params import (
    STAGNATION_SPIN_THRESHOLD, STAGNATION_OSCILLATION_CYCLES,
    STAGNATION_NO_DRIFT_EPSILON, STAGNATION_DIMINISHING_RATE,
...
class StagnationDetector:
    ...
    def _fire(self, agent_id: str, pattern: str, reason: str) -> None:
        ...
        try:
            from kernel.interrupt import fire, InterruptType
