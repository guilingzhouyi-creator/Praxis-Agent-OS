...
def convene(cell: Any, issue_card: Any) -> dict:
    from .issue import IssueCard, IssueCardStatus, get_table
    ...
    from .convention import ConventionProtocol
...
def close_convention(cell: Any, issue_card_id: str) -> dict:
    ...
    from .convergence import converge as _converge, to_execution_card
...
def _get_convention(cell: Any, issue_card: Any) -> Any:
    ...
    if conv:
        return conv
    from .convention import ConventionProtocol as ConvCls
