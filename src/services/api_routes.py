...
API_ROUTES: list[tuple[str, str, str, str]] = [
    ...
    # ── Prompt Engine ──
    ("POST", "/api/prompt/build",       "services.prompt_engine.handle_prompt_build",    "Build prompt"),
    ("POST", "/api/prompt/context",     "services.prompt_engine.handle_prompt_context",  "Context assembly"),
    ("GET",  "/api/prompt/templates",   "services.prompt_engine.handle_prompt_templates","List templates"),
    ("POST", "/api/prompt/template",    "services.prompt_engine.handle_prompt_template_register","Register template"),
