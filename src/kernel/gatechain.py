...
from .params import (
    LEDGER_MAX_ENTRIES, LEDGER_RECENT_LIMIT, LEDGER_COUNT_WINDOW,
    GATECHAIN_DEFAULT_DANGER, GATECHAIN_DANGER_LEVELS, GATECHAIN_TOOLS_KEY,
    GATECHAIN_FREQ_MULTIPLIER, GATECHAIN_RISK_WARN_THRESHOLD,
    GATECHAIN_ESCALATION_DANGER, GATECHAIN_SENDER, GATECHAIN_L3_TARGET,
    GATECHAIN_G5_HISTORY_LIMIT, GATECHAIN_REPEAT_THRESHOLD,
    GATECHAIN_HIGH_FREQ_THRESHOLD, GATECHAIN_DANGER_WEIGHT,
    GATECHAIN_HISTORY_WEIGHT, GATECHAIN_FREQ_WEIGHT,
    GATECHAIN_G1_INDEX, GATECHAIN_G3_INDEX, GATECHAIN_PATTERN_TEMPLATE,
)
...
def _gate_g5(ctx: dict, gc: GateChain) -> tuple[list[dict], GateResult]:
    ...
    if rep >= 0.9 and g3_result == "WARN":
        ...
        from services.stagnation import get_detector
