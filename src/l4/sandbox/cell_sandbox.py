...
def _classify_hunk_semantic(hunk: dict) -> str:
...
class CellSandbox:
    ...
    @staticmethod
    def _compute_hunks(old_text: str, new_text: str,
        ...
        for h in hunks:
            h["semantic"] = _classify_hunk_semantic(h)
    ...
    def write(self, rel_path: str, content: str, agent_id: str,
        ...
        try:
            ...
            now = time.time()
            hunks = self._compute_hunks(old_content, content,
