...
_DOMAIN_BY_PREFIX: dict[str, str] = {
    ...
    "/api/card-gate": "approval",
    "/api/card_gate": "approval",
    ...
    "/api/model-spec": "provider",
    "/api/subagent": "subagent",
    "/api/scout": "scout",
    "/api/r4": "r4",
    "/api/l3a": "l3a",
    "/api/skills": "skill",
...
_DOMAIN_GROUP: dict[str, str] = {
    ...
    "mcp": "bus-services",
    "plugin": "bus-services",
    "subagent": "bus-services",
    "scout": "bus-services",
    "r4": "bus-services",
    "provider": "bus-services",
    "cron": "bus-services",
    "stats": "bus-services",
    "agent": "bus-services",
    # fallback
...
_CENTRAL: list[ApiEndpoint] = [
    ApiEndpoint(
        method=m, path=p, handler_ref=h, description=d, domain=_infer_domain(p), source="api_routes", kind="http"
    )
...
_SCATTERED: list[ApiEndpoint] = [
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/subagent/dispatch",
        "l3.agent.subagent_framework.handle_subagent_dispatch",
        "Dispatch subagent (@mention or spec+prompt)",
        "subagent",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/subagent/result",
        "l3.agent.subagent_framework.handle_subagent_result",
        "Get subagent task result",
        "subagent",
        "l3.agent.subagent_framework",
        "http",
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/subagent/cancel",
        "l3.agent.subagent_framework.handle_subagent_cancel",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/subagent/tasks",
        "l3.agent.subagent_framework.handle_subagent_list",
        "List subagent tasks",
        "subagent",
        "l3.agent.subagent_framework",
        "http",
    ...
    ApiEndpoint(
        "GET",
        "/api/v2/subagent/specs",
        "l3.agent.subagent_framework.handle_subagent_specs",
        "List subagent specs",
        "subagent",
        "l3.agent.subagent_framework",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/subagent/spec",
        "l3.agent.subagent_framework.handle_subagent_spec_register",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/subagent/merge",
        "l3.agent.subagent_framework.handle_subagent_merge",
    ...
    ApiEndpoint(
        "GET", "/api/v2/logs/recent", "l3.bus.log.handle_log_recent", "Recent log entries", "log", "l3.bus.log", "http"
    ),
    ApiEndpoint(
        "GET", "/api/v2/logs/stats", "l3.bus.log.handle_log_stats", "Log statistics", "log", "l3.bus.log", "http"
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/logs/export",
        "l3.bus.log.handle_log_export",
        "Export logs to JSON",
        "log",
        "l3.bus.log",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/edit",
        "l3.services.file_editor.handle_fs_edit",
        "Semantic file edit (search/replace)",
        "fs",
        "l3.services.file_editor",
        "http",
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/fs/batch-edit",
        "l3.services.file_editor.handle_fs_batch_edit",
        "Atomic batch multi-file edit",
        "fs",
        "l3.services.file_editor",
        "http",
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/fs/history",
        "l3.services.file_editor.handle_fs_history",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/undo",
        "l3.services.file_editor.handle_fs_undo",
        "Undo file operation",
        "fs",
        "l3.services.file_editor",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/redo",
        "l3.services.file_editor.handle_fs_redo",
        "Redo file operation",
        "fs",
        "l3.services.file_editor",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/patch",
        "l3.services.file_editor.handle_fs_patch_create",
        "Create patch from history",
        "fs",
        "l3.services.file_editor",
        "http",
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/fs/patch/apply",
        "l3.services.file_editor.handle_fs_patch_apply",
        "Apply patch",
        "fs",
        "l3.services.file_editor",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/patch/revert",
        "l3.services.file_editor.handle_fs_patch_revert",
        "Revert patch",
        "fs",
        "l3.services.file_editor",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/patches",
        "l3.services.file_editor.handle_fs_patch_list",
        "List all patches",
        "fs",
        "l3.services.file_editor",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/fs/patch/get",
        "l3.services.file_editor.handle_fs_patch_get",
        "Get patch detail",
        "fs",
        "l3.services.file_editor",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/prompt/build",
        "l3.services.prompt_engine.handle_prompt_build",
        "Build full prompt with context assembly",
        "prompt",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/prompt/context",
        "l3.services.prompt_engine.handle_prompt_context",
        "Assemble context only (preview)",
        "prompt",
        "l3.services.prompt_engine",
        "http",
    ),
    ApiEndpoint(
        "GET",
        "/api/v2/prompt/templates",
        "l3.services.prompt_engine.handle_prompt_templates",
    ...
    ApiEndpoint(
        ...
        "l3.services.session_export.handle_session_export",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/session/import",
        "l3.services.session_export.handle_session_import",
    ...
    ApiEndpoint(
        "GET",
        "/api/v2/session/snapshots",
        "l3.services.session_export.handle_session_snapshots",
        "List snapshots",
        "session",
        "l3.services.session_export",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/config",
        "l4.api_handlers.api_handlers_config.handle_config_list",
        "List all config (optional filter: {category})",
        "config",
        "l4.api_handlers.api_handlers_config",
        "http",
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/config/get",
        "l4.api_handlers.api_handlers_config.handle_config_get",
    ...
    ApiEndpoint(
        "PUT",
        "/api/v2/config/set",
        "l4.api_handlers.api_handlers_config.handle_config_set",
        "Set config override at runtime",
        "config",
        "l4.api_handlers.api_handlers_config",
        "http",
    ),
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/lsp/diagnostics",
        "l4.lsp.lsp_manager.handle_lsp_diagnostics",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/lsp/hover",
        "l4.lsp.lsp_manager.handle_lsp_hover",
        "Get hover info",
        "lsp",
        "l4.lsp.lsp_manager",
        "http",
    ...
    ApiEndpoint(
        "GET",
        "/api/v2/lsp/servers",
        "l4.lsp.lsp_manager.handle_lsp_servers",
        "List LSP server status",
        "lsp",
        "l4.lsp.lsp_manager",
        "http",
    ),
    ApiEndpoint(
        "POST",
        "/api/v2/lsp/start",
        "l4.lsp.lsp_manager.handle_lsp_start",
        "Start LSP server",
        "lsp",
        "l4.lsp.lsp_manager",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/lsp/stop",
        "l4.lsp.lsp_manager.handle_lsp_stop",
        "Stop LSP server",
        "lsp",
        "l4.lsp.lsp_manager",
        "http",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/lsp/feedback",
        "l4.lsp.lsp_manager.handle_lsp_feedback",
        "Post-edit feedback loop",
        "lsp",
        "l4.lsp.lsp_manager",
        "http",
    ),
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/search",
        "l4.search.search_engine.handle_search",
        "Unified search (auto-select mode)",
        "search",
    ...
    ApiEndpoint(
        ...
        "l4.search.search_engine.handle_search_semantic",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/search/symbol",
        "l4.search.search_engine.handle_search_symbol",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/search/docs",
        "l4.search.search_engine.handle_search_docs",
    ...
    ApiEndpoint(
        "POST",
        "/api/v2/search/docs/index",
        "l4.search.search_engine.handle_search_index_doc",
        "Index custom API doc",
        "search",
        "l4.search.search_engine",
        "http",
    ),
    ...
    ApiEndpoint(
        "GET",
        "/api/v2/events",
        "l4.sse.sse_bridge.handle_sse",
        "SSE event stream (EventBus over HTTP)",
        "sse",
        "l4.sse.sse_bridge",
        "http",
    ),
...
_OUTBOUND: list[ApiEndpoint] = [
    ...
    ApiEndpoint(
        ...
        "registry",
        "l3.card.card_registry_protocol",
        "outbound",
    ),
    ApiEndpoint(
        "GET",
        "{base}/api/v1/cards/{name}",
        "",
        "Download card definition (.yaml)",
        "registry",
        "l3.card.card_registry_protocol",
        "outbound",
    ),
    ApiEndpoint(
        "POST",
        "{base}/api/v1/cards/publish",
        "",
        "Publish a card definition",
        "registry",
        "l3.card.card_registry_protocol",
        "outbound",
    ),
...
def get_endpoints(domain: str = "", group: str = "", source: str = "", kind: str = "") -> list[ApiEndpoint]:
...
def register_domain(domain: str, group: str) -> dict:
    ...
    return {"success": True, "domain": domain, "group": group, "groups": sorted(set(_DOMAIN_GROUP.values()))}
...
def validate() -> dict:
    ...
    for e in _SCATTERED:
        if (e.method, e.path) not in central_keys:
            issues.append(f"scattered endpoint not in API_ROUTES: {e.method} {e.path} (source={e.source})")
    ...
    slash_paths = sorted({f"{e.method} {e.path}" for e in ENDPOINT_MANIFEST if e.path.endswith("/")})
    if slash_paths:
    ...
    unknown_groups = sorted({e.group for e in ENDPOINT_MANIFEST if e.group not in DOMAIN_GROUPS})
    if unknown_groups:
