...
API_ROUTES: list[tuple[str, str, str, str]] = [
    ...
    # Shell commands
    ("GET", "/api/v2/commands",        "l4.api_handlers.api_handlers_commands.handle_commands_list",  "List all commands (system + user)"),
    ("POST", "/api/v2/commands",       "l4.api_handlers.api_handlers_commands.handle_commands_register", "Register a user command"),
    ("DELETE", "/api/v2/commands/{name}","l4.api_handlers.api_handlers_commands.handle_commands_remove", "Unregister a user command"),
    ("PUT", "/api/v2/commands/{name}",  "l4.api_handlers.api_handlers_commands.handle_commands_update",  "Update a user command"),
    ...
    ("GET",  "/api/v2/discussion/{session_id}",           "l4.api_handlers.api_handlers_discussion.handle_discussion_get",                  "Get session status"),
    ("GET",  "/api/v2/discussion/{session_id}/answers",   "l4.api_handlers.api_handlers_discussion.handle_discussion_answers",              "Get raw cell answers"),
    ("GET",  "/api/v2/discussion/{session_id}/report",    "l4.api_handlers.api_handlers_discussion.handle_discussion_report",               "Get aggregated report"),
    ("POST", "/api/v2/discussion/{session_id}/supplement","l4.api_handlers.api_handlers_discussion.handle_discussion_supplement",            "Submit supplement issue"),
    ...
    # Diff / Sandbox API
    ("POST", "/api/v2/diff/structured",   "l4.api.api_handlers_diff.diff_structured",   "Get structured diff for sandbox-staged file"),
    ...
    ("GET",  "/api/v2/config/categories",  "l4.api_handlers.api_handlers_config.handle_config_categories","List categories"),
    ...
    ("POST", "/api/v2/prompt/template",    "l3.services.prompt_engine.handle_prompt_template_register","Register template"),
    ...
    ("POST", "/api/v2/session/snapshot",           "l3.services.session_export.handle_session_snapshot_create",      "Create snapshot"),
    ("POST", "/api/v2/session/snapshot/restore",   "l3.services.session_export.handle_session_snapshot_restore",    "Restore snapshot"),
    ("POST", "/api/v2/session/snapshot/delete",    "l3.services.session_export.handle_session_snapshot_delete",     "Delete snapshot"),
    ...
    ("GET",  "/api/v2/monitor/stats",     "l4.api_handlers.api_handlers_monitor.handle_monitor_stats",      "Monitor event statistics"),
    ("GET",  "/api/v2/monitor/stream",    "l4.api_handlers.api_handlers_monitor.handle_monitor_stream",     "SSE monitor event stream"),
    ("GET",  "/api/v2/monitor/gate",      "l4.api_handlers.api_handlers_monitor.handle_message_gate_list",  "List message gate rules"),
    ("POST", "/api/v2/monitor/gate",      "l4.api_handlers.api_handlers_monitor.handle_message_gate_set",   "Set message gate rule"),
    ("DELETE","/api/v2/monitor/gate/{id}",    "l4.api_handlers.api_handlers_monitor.handle_message_gate_remove", "Remove message gate rule"),
    ...
    ("PUT",    "/api/v2/skills/{name}",    "l4.api_handlers.api_handlers_skills.handle_skills_update",       "Update skill (developer)"),
