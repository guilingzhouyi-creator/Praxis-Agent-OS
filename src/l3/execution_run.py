...
from l3.plan_step_types import StepState
from l3.card import PhaseMode

logger = logging.getLogger(__name__)


def execute(plan, timeout: float = 300.0) -> dict:
...
def _execute_step(plan, ps, timeout: float) -> dict:
    ...
    from l3.agent_terminal import get_terminal
    from l3.execution_verify import execute_scout, execute_scout_verify, diff_verify
    tool = ps.action
...
def _execute_scout(ps) -> dict:
    ...
    from l3.execution_verify import execute_scout as _es
    return _es(ps)
...
def _execute_agent(plan, ps, agent_id: str, timeout: float) -> dict:
    ...
    from l3.execution_verify import execute_scout_verify as _esv
    from l3.cell_types import is_scout, is_subagent
    ...
    from l3._term_handlers import get_action_handler
