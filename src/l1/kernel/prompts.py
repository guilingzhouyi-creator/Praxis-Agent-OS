...
_DEFAULTS: dict[str, str] = {
    ...
    "l3a.agentloop_system": (
        ...
        "1. Understand what the user wants — if the request is ambiguous or "
        "critical information is missing, call 'l3a_ask' first to raise "
        "clarifying questions (max 5). Execution pauses until the user "
        "answers in the chat window, then resumes automatically.\n"
