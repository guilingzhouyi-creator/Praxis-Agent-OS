...
description: Use when writing Python tests, setting up test suites, mocking external dependencies, or implementing testing best practices with pytest — fixtures, parameterization, retry, freezegun, markers, coverage.
---
