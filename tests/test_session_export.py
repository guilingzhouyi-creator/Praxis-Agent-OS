...
class TestSessionExportModel:
    ...
    def test_version(self):
        from services.session_export import SessionExport
        s = SessionExport()
        assert s.version == 2
