...
class TestDiagnosticCache:
    ...
    def test_cache_set_get(self):
        from services.lsp_manager import DiagnosticCache, FileDiagnostics, DiagnosticEntry
    ...
    def test_cache_ttl(self):
        import time
        from services.lsp_manager import DiagnosticCache, FileDiagnostics
...
class TestApiHandlers:
    ...
    def test_handle_lsp_diagnostics_missing_file(self):
        from services.lsp_manager import handle_lsp_diagnostics
    ...
    def test_handle_lsp_feedback_no_file(self):
        from services.lsp_manager import handle_lsp_feedback
        r = handle_lsp_feedback({})
        assert not r["success"]

    def test_handle_lsp_servers(self):
        from services.lsp_manager import handle_lsp_servers
        r = handle_lsp_servers()
        assert r["success"]
        assert "servers" in r

    def test_handle_lsp_start_stop(self):
        from services.lsp_manager import handle_lsp_start, handle_lsp_servers
