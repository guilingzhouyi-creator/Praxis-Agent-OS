...
class TestConventionData:
    def test_transcript_create(self):
        from services.convention import ConventionTranscript
    ...
    def test_round_create(self):
        from services.convention import ConventionRound
    ...
    def test_add_transcript(self):
        from services.convention import ConventionRound, ConventionTranscript
