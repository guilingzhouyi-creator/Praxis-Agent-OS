...
class TestAssemblyData:
    def test_proposal_create(self):
        from services.assembly import Proposal
    ...
    def test_challenge_create(self):
        from services.assembly import Challenge
    ...
    def test_response_create(self):
        from services.assembly import Response
    ...
    def test_issue_document_create(self):
        from services.assembly import IssueDocument
    ...
    def test_issue_document_add_proposal(self):
        from services.assembly import IssueDocument, Proposal
    ...
    def test_issue_document_add_challenge(self):
        from services.assembly import IssueDocument, Challenge
    ...
    def test_issue_document_add_response(self):
        from services.assembly import IssueDocument, Challenge, Response
    ...
    def test_is_blank_constitution(self):
        from services.assembly import IssueDocument
        from kernel.constitution import TerritoryConstitution
