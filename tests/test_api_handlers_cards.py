...
def test_module_imports():
    from services.api_handlers_cards import list_cards, get_card, submit_card
...
def test_submit_batch_import():
    from services.api_handlers_cards import submit_batch, card_rollback
    assert callable(submit_batch)
    assert callable(card_rollback)


def test_extra_imports():
    from services.api_handlers_cards import card_gate_history, sideload_dispatch
