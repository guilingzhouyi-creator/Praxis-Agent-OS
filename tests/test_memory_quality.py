...
def test_score_importance():
    from services.memory_quality import _score_importance
...
def test_is_good_memory():
    from services.memory_quality import _is_good_memory
...
def test_suggest_compact():
    from services.memory_quality import _suggest_compact
    class MockEntry:
...
def test_import_module():
    from services.memory_quality import _MIN_CONTENT_LEN, _ALWAYS_SAVE
