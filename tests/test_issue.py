...
class TestIssueData:
    def test_issue_status_enum(self):
        from services.issue import IssueStatus
...
class TestIssueTable:
    ...
    def test_submit_and_get(self):
        from services.issue import IssueCard, IssueItem, get_table
        table = get_table()
    ...
    def test_set_status(self):
        from services.issue import IssueCard, IssueItem, IssueCardStatus, get_table
        table = get_table()
