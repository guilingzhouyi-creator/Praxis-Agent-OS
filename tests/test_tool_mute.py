...
class TestToolMute:
    def test_mute_unmute_tool(self):
        from l3.tool_spec import mute_tool, unmute_tool, is_muted, clear_mutes
        clear_mutes()
    ...
    def test_mute_category(self):
        from l3.tool_spec import mute_category, unmute_category, is_muted, clear_mutes
        from l3.tool_spec import register, ToolSpec
        clear_mutes()
    ...
    def test_mute_ring(self):
        from l3.tool_spec import mute_ring, unmute_ring, is_muted, clear_mutes
        from l3.tool_spec import register, ToolSpec
        clear_mutes()
    ...
    def test_execute_muted_returns_error(self):
        from l3.tool_spec import mute_tool, clear_mutes, execute_tool_spec
        from l3.tool_spec import register, ToolSpec
        clear_mutes()
    ...
    def test_list_muted(self):
        from l3.tool_spec import mute_tool, mute_category, clear_mutes, list_muted
        clear_mutes()
        mute_tool("foo")
        mute_category("bar")
        result = list_muted()
