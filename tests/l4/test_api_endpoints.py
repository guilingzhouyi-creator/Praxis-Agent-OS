...
class TestWorkDomainGroups:
    ...
    def test_domain_groups_catalogue(self):
        ...
        for g in ("shell", "kernel", "memory", "sessions", "tools", "card-cell", "bus-services", "misc"):
...
class TestGenericRegistration:
    def test_register_domain(self):
        from l4.api.api_endpoints import _infer_group, register_domain
    ...
    def test_register_endpoint_infers_group(self):
        ...
        ep = register_endpoint("POST", "/api/v2/workflow/run", "mod.h", "desc", domain="workflow")
