...
class TestHTNB:
    def test_create_htn_b(self):
        from l3.htn_b import create_htn_b
    ...
    def test_route_forward(self):
        from l3.htn_b import _decompose_route_forward
        from l3.htn_planner import Task, TaskType
    ...
    def test_merge_result(self):
        from l3.htn_b import _decompose_merge_result
        from l3.htn_planner import Task, TaskType
...
class TestL3BBus:
    ...
    def test_send_unknown_target(self):
        from l3.l3b_bus import L3BBus, L3BMessageType
        bus = L3BBus()
        bus.register("comp-x")
