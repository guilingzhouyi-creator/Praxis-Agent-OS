...
class TestAssemblyData:
    def test_proposal_create(self):
        from l3.services.assembly import Proposal
    ...
    def test_challenge_create(self):
        from l3.services.assembly import Challenge
    ...
    def test_response_create(self):
        from l3.services.assembly import Response
    ...
    def test_issue_document_create(self):
        from l3.services.assembly import IssueDocument
    ...
    def test_issue_document_add_proposal(self):
        from l3.services.assembly import IssueDocument, Proposal
    ...
    def test_issue_document_add_challenge(self):
        from l3.services.assembly import Challenge, IssueDocument
