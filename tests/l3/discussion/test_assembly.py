...
class TestAssemblyData:
    def test_proposal_create(self):
        from l3.assembly import Proposal
    ...
    def test_challenge_create(self):
        from l3.assembly import Challenge
    ...
    def test_response_create(self):
        from l3.assembly import Response
    ...
    def test_issue_document_create(self):
        from l3.assembly import IssueDocument
    ...
    def test_issue_document_add_proposal(self):
        from l3.assembly import IssueDocument, Proposal
    ...
    def test_issue_document_add_challenge(self):
        from l3.assembly import IssueDocument, Challenge
    ...
    def test_issue_document_add_response(self):
        from l3.assembly import IssueDocument, Challenge, Response
