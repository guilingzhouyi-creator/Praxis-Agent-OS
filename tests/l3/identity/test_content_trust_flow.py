...
class TestContentTrust:
    ...
    def test_tag_provenance(self):
        ...
        prov = ct.tag(source_type="agent", source_id="test-agent", method="tool_call", trace_id="trace-1")
    ...
    def test_can_store_check(self):
        ...
        ct = get_trust("default")
        prov = ct.tag(source_type="agent", source_id="writer", method="decision", trace_id="")
        r = ct.can_store(prov)
    ...
    def test_can_recall_check(self):
        ...
        ct = get_trust("default")
        prov = ct.tag(source_type="agent", source_id="reader", method="observation", trace_id="")
