...
from l3.tool_system.tool_policy import (
    PolicyAction,
    PolicyRule,
    PolicyScope,
    ToolPolicy,
...
class TestRuleKey:
    ...
    def test_different_tools_have_different_keys(self):
        r1 = PolicyRule(scope=PolicyScope.GLOBAL, scope_id="", tool="read_file", action=PolicyAction.DISABLE)
        r2 = PolicyRule(scope=PolicyScope.GLOBAL, scope_id="", tool="write_file", action=PolicyAction.DISABLE)
