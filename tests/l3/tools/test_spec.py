...
class TestRegister:
    ...
    def test_register_and_get(self):
        from l3.tool_system.tool_spec import TOOL_REGISTRY, ToolSpec, clear_tools, register
        clear_tools()
    ...
    def test_list_by_category(self):
        from l3.tool_system.tool_spec import ToolSpec, clear_tools, list_tools, register
        clear_tools()
        for i in range(3):
...
class TestExecute:
    ...
    def test_execute_success(self):
        from l3.tool_system.tool_spec import clear_tools, execute_tool
        clear_tools()
        recorded = []
    ...
    def test_execute_no_handler(self):
        from l3.tool_system.tool_spec import ToolSpec, clear_tools, execute_tool, register
        clear_tools()
...
class TestMute:
    ...
    def test_mute_tool(self):
        from l3.tool_system.tool_spec import clear_mutes, clear_tools, is_muted, mute_tool
        clear_mutes()
        clear_tools()
        mute_tool("some_tool")
    ...
    def test_unmute_tool(self):
        from l3.tool_system.tool_spec import clear_mutes, clear_tools, is_muted, mute_tool, unmute_tool
        clear_mutes()
        clear_tools()
