...
class TestToolSpec:
    ...
    def test_to_dict(self):
        ...
        spec = ToolSpec(name="dict_tool", description="desc", category="gen", ring="RING_1", danger=1)
        d = spec.to_dict()
...
class TestRegister:
    ...
    def test_register_and_get(self):
        ...
        _clear_tools()
        spec = ToolSpec(
            name="reg_tool", description="test", category="gen", ring="RING_1", danger=0, handler=lambda a, b: {}
        )
        register(spec)
    ...
    def test_list_by_ring(self):
        ...
        register(
            ToolSpec(
                name="ring2_tool", description="t", category="gen", ring="RING_2_5", danger=1, handler=lambda a, b: {}
            )
        )
    ...
    def test_register_duplicate(self):
        ...
        _clear_tools()
        spec = ToolSpec(name="dup", description="d", category="c", ring="RING_1", danger=0, handler=lambda a, b: {})
        register(spec)
